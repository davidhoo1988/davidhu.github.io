...
<p align="center">
 ...
 <div>接着考虑Circuit Bootstrap的计算复杂度。容易知道一共需要做<img src="https://latex.codecogs.com/svg.image?d_g" title="https://latex.codecogs.com/svg.image?d_g" />次bootstrap 和 <img src="https://latex.codecogs.com/svg.image?2d_g" title="https://latex.codecogs.com/svg.image?2d_g" />次 Private KS。单次bootstrap需要 </div>
