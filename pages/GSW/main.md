...
为了解决这个问题，首先引入中间状态下的GSW乘法 <img src="http://latex.codecogs.com/svg.latex?\diamond&space;:&space;RLWE'\times&space;RGSW\to&space;RLWE'" title="http://latex.codecogs.com/svg.latex?\diamond : RLWE'\times RGSW\to RLWE'" /> 。
