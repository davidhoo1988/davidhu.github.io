...
<img src="https://latex.codecogs.com/svg.image?ct_{Q,ksk}\sim&space;\mathcal{N}(0,\sigma_{ct}^2)&space;\text{&space;with&space;}&space;\sigma_{ct}^2\leq&space;&space;\sigma_{BR}^2&plus;Nd_ks\frac{B_{ks}^2}{3}\cdot&space;\sigma^2_{ksk}&space;" title="https://latex.codecogs.com/svg.image?ct_{Q,ksk}\sim \mathcal{N}(0,\sigma_{ct}^2) \text{ with } \sigma_{ct}^2\leq \sigma_{BR}^2+Nd_ks\frac{B_{ks}^2}{3}\cdot \sigma^2_{ksk} " /> 。
